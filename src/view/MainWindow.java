...
public class MainWindow extends javax.swing.JDialog {
    private Container jDesktopPane1;
    ...
    private void initComponents() {
        ...
        jMenuItem2.setText("Add Resource");
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        CreateProjectMenu f=new CreateProjectMenu();
        f.setVisible(true);
        jDesktopPane2.add(f);
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        AddResourceMenuItem r=new AddResourceMenuItem();
        r.setVisible(true);
        jDesktopPane2.add(r);
        setContentPane(jDesktopPane2);         
    ...
    private static class jDesktopPane2 {

        private static void add(AddResourceMenuItem f) {
